...
int main(int argc, char** argv) {
    ...
    const bool enable_integer_inequality_propagation =
        argc > 16 && std::string(argv[16]) == "on";
    ...
    std::cout << "time_limit_seconds=" << time_limit << " branching_rule=" << branching_rule
              ...
              << " integer_inequality_propagation="
              << (enable_integer_inequality_propagation ? "on" : "off")
    ...
    std::cout << std::left << std::setw(18) << "instance" << std::right << std::setw(12)
              ...
              << "GPU_MB" << std::setw(8) << "cuts" << std::setw(8) << "coef" << std::setw(8) << "fp" << std::setw(8) << "gcd"
    ...
    for (const fs::path& instance : instances) {
        ...
        try {
            ...
            options.use_rounding_heuristic = enable_rounding_heuristic;
            ...
            options.enable_integer_inequality_propagation = enable_integer_inequality_propagation;
            ...
            std::cout << std::left << std::setw(18) << name << std::right << std::setw(12)
                      ...
                      << std::setw(8) << result.feasibility_pump_lp_relaxations
