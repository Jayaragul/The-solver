...
short budget effect. The million-iteration run used the new
`--check-every 1000` option to reduce diagnostic synchronization overhead.
...
| 1,000,000 (`--check-every 1000`) | -0.00788942603681 | 1.278e-05 | 2.275e-05 | 88.401667 | passed |

The residual improves by roughly 2.9×, while the longer checkpoint interval
reduces runtime by about 9% (97.10 s to 88.40 s). It remains above the `1e-5`
